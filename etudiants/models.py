...
class Etudiant(models.Model):
    ...
    type_etudiant = models.CharField(
        max_length=50,
        choices=status_etudiant,
    )
    etablissement = models.ForeignKey(
        "gestion_academique.Etablissement",
        related_name="etudiant_etablissement",
        on_delete=models.CASCADE,
    )
    etablissement_d_origine = models.ForeignKey(
        EtablissementDorigine,
        related_name="etudiant_etablissement_origine",
        on_delete=models.CASCADE,
    )
    ...
    nationalite = CountryField(
        blank_label="(Selectionner le pays)", blank=True, null=True
    )
    ...
    fiche_orientation = models.FileField(
        upload_to="etudiant/fiche_orientation", null=True, blank=True
    )
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.matricule:
            ...
            max_matricule_with_base = (
                Etudiant.objects.filter(matricule__startswith=base_matricule)
                .order_by("-matricule")
                .first()
            )
...
class SessionSoutenanceNew(models.Model):
    ...
    etablissement = models.ForeignKey(
        "gestion_academique.Etablissement",
        related_name="session_etablissement",
        on_delete=models.CASCADE,
    )
...
class AttestationNew(models.Model):
    ...
    session = models.ForeignKey(
        SessionSoutenanceNew,
        related_name="AttestationNew_session",
        on_delete=models.CASCADE,
    )
...
class SessionDiplome(models.Model):
    ...
    etablissement = models.ForeignKey(
        "gestion_academique.Etablissement",
        related_name="session_diplome_etablissement",
        on_delete=models.CASCADE,
    )
...
class Diplome(models.Model):
    ...
    session = models.ForeignKey(
        SessionDiplome, related_name="Diplome_session", on_delete=models.CASCADE
    )
    nom = models.CharField(max_length=150)
    prenom = models.CharField(max_length=150)
...
class CertificatSession(models.Model):
    ...
    etablissement = models.ForeignKey(
        "gestion_academique.Etablissement",
        related_name="session_certificat_etablissement",
        on_delete=models.CASCADE,
    )
    fichier = models.FileField(upload_to="diplome/fichier", null=True, blank=True)
    active = models.BooleanField(default=True)
...
class Certificat(models.Model):
    ...
    session = models.ForeignKey(
        CertificatSession, related_name="certificat_session", on_delete=models.CASCADE
    )
    nom = models.CharField(max_length=150)
    prenom = models.CharField(max_length=150)
    diplome = models.CharField(max_length=150)
